const time = require('../config/timestamp')
 ...
 module.exports = {
     ...
     top10: async function(interaction) {
         ...
         const Levels = new ActionRowBuilder()
             ...
             const Top10 = new EmbedBuilder()
                 ...
                 .setDescription(`Hey **${interaction.member.displayName}**! Here is the **Top 10** board you asked for.`)
                 .addFields(
     ...
     top20: async function(interaction) {
 		...
 		.setThumbnail(interaction.member.displayAvatarURL())
 		.setAuthor({ name: interaction.member.displayName, iconURL: interaction.member.displayAvatarURL({ dynamic: true }) })
 		.setDescription(`Hey **${interaction.member.displayName}**! Here is the **11-20** board you asked for.`)
 		.addFields(
     ...
     top30: async function(interaction) {
 		...
 		.setThumbnail(interaction.member.displayAvatarURL())
 		.setAuthor({ name: interaction.member.displayName, iconURL: interaction.member.displayAvatarURL({ dynamic: true }) })
 		.setDescription(`Hey **${interaction.member.displayName}**! Here is the **21-30** board you asked for.`)
 		.addFields(
 			{ name: `${guildName} - XP Leaderboard`, value: `**Level - XP**\n` },
     ...
     top40: async function(interaction) {
 		...
 		.setThumbnail(interaction.member.displayAvatarURL())
 		.setAuthor({ name: interaction.member.displayName, iconURL: interaction.member.displayAvatarURL({ dynamic: true }) })
 		.setDescription(`Hey **${interaction.member.displayName}**! Here is the **31-40** board you asked for.`)
 		.addFields(
 			{ name: `${guildName} - XP Leaderboard`, value: `**Level - XP**\n` },
     ...
     top50: async function(interaction) {
 		...
 		.setThumbnail(interaction.member.displayAvatarURL())
 		.setAuthor({ name: interaction.member.displayName, iconURL: interaction.member.displayAvatarURL({ dynamic: true }) })
 		.setDescription(`Hey **${interaction.member.displayName}**! Here is the **41-50** board you asked for.`)
 		.addFields(
 			{ name: `${guildName} - XP Leaderboard`, value: `**Level - XP**\n` },
